...
def order_disordered(struct):
    ...
    orthog = OrthorhombicSupercellTransform(300)
...
if __name__ == "__main__":
    ...
    for fold in task.folds[:1]:
        ...
        if not exists("Data/CV_hdf5/matbench_mp_gap_cubic_300_COO_train" + "_" + str(fold_n) + ".hdf5"):
            h5_dataset_from_structure_list("Data/CV_hdf5/matbench_mp_gap_cubic_300_COO_train" + "_" + str(fold_n) + ".hdf5", structure_dict)
        ...
        structure_dict = {i[0]: j for i, j in tqdm(zip(structure_list, ordered_structures))}
        if not exists("Data/CV_hdf5/matbench_mp_gap_cubic_300_COO_test" + "_" + str(fold_n) + ".hdf5"):
            h5_dataset_from_structure_list("Data/CV_hdf5/matbench_mp_gap_cubic_300_COO_test" + "_" + str(fold_n) + ".hdf5", structure_dict)
