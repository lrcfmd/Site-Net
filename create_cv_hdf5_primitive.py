...
if __name__ == "__main__":
    ...
    #Fold to train with
    #configuration file for hparams
    ...
    for fold in task.folds:
        ...
        ordered_structures = [
            [ordered_structures[i], structure_list[i][2]]
            for i in range(len(structure_list))
        ]

        structure_dict = {i[0]: j for i, j in tqdm(zip(structure_list, ordered_structures))}
        h5_dataset_from_structure_list("Data/CV_hdf5/matbench_mp_e_form_train" + "_" + str(fold_n) + ".hdf5", structure_dict)
        
        #test data
        
        structure_list = [[i, j, 0] for i, j in zip(test_inputs.index, test_inputs)]
        ...
        structure_dict = {i[0]: j for i, j in tqdm(zip(structure_list, ordered_structures))}
        h5_dataset_from_structure_list("Data/CV_hdf5/matbench_mp_e_form_test" + "_" + str(fold_n) + ".hdf5", structure_dict)
    ...
    for fold in task.folds[:1]:
        ...
        structure_dict = {i[0]: j for i, j in tqdm(zip(structure_list, ordered_structures))}
        if not exists("Data/CV_hdf5/matbench_mp_gap_primitive_COO_train" + "_" + str(fold_n) + ".hdf5"):
            h5_dataset_from_structure_list("Data/CV_hdf5/matbench_mp_gap_primitive_COO_train" + "_" + str(fold_n) + ".hdf5", structure_dict)
        ...
        structure_dict = {i[0]: j for i, j in tqdm(zip(structure_list, ordered_structures))}
        if not exists("Data/CV_hdf5/matbench_mp_gap_primitive_COO_test" + "_" + str(fold_n) + ".hdf5"):
            h5_dataset_from_structure_list("Data/CV_hdf5/matbench_mp_gap_primitive_COO_test" + "_" + str(fold_n) + ".hdf5", structure_dict)
