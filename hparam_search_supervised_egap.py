...
def train_infomax_asha_ng(config, Dataset, scheduler):
    ...
    # }
    hopt_kwargs = {
        "embedding_size": tune.randint(1, 128),
        "graph_embedding_dim_per_block_per_head": tune.randint(4,32),
        "node_dim_per_head": tune.randint(4,32),
        "attention_dim_edge": tune.randint(4,32),
        "attention_blocks": tune.randint(1, 3),
        "attention_heads": tune.randint(1, 8),
        "pre_pool_layers_n": tune.randint(1, 4),
        "post_pool_layers_n": tune.randint(1, 4),
        "attention_hidden_layers_n": tune.randint(1, 3),
        "pre_pool_layers_size": tune.randint(32, 256),
        "post_pool_layers_size": tune.randint(32, 256),
        "attention_hidden_layers_size": tune.randint(32, 256),
        "Batch_Size": tune.randint(8, 24),
        "Learning_Rate": tune.loguniform(5e-5, 1e-2),
        "activation_function": tune.choice(["mish"]),
        "set_norm": tune.choice(["layer", "none"]),
        "lin_norm": tune.choice(["layer", "none"]),
    }
